...
DEFAULT_GOOGLE_PLACES_CACHE = (
    PROJECT_ROOT / "data" / "google-places-bathrooms-cache.json"
)
DEFAULT_GOOGLE_PLACES_USAGE = PROJECT_ROOT / "data" / "google-places-usage.json"
...
GOOGLE_PLACES_REQUEST_LIMIT = 1_000
DEFAULT_PLACES_ANCHOR_SPACING_METERS = 2_400.0
DEFAULT_PLACES_SEARCH_RADIUS_METERS = 2_000.0
...
MANUAL_POINTS = {
    "Washington Blvd / West Washington Blvd": (
        33.988432,
        -118.451976,
        "Washington Boulevard / West Washington transition, Venice, CA",
    ),
    "W 78th St / W 79th St": (
        33.968500,
        -118.385000,
        "West 78th Street / West 79th Street transition, Los Angeles, CA",
    ),
    "Centinela Ave / Sepulveda Blvd": (
        33.977003,
        -118.386247,
        "West Centinela Avenue, Culver City, CA",
    ),
    ...
    "PCH / river-trail exit area": (
        33.773900,
        -118.202400,
        "Ocean Blue Environmental, 925 W Esther Street, Long Beach, CA",
    ),
    "Oceanside Coast Highway 101": (
        33.2265,
        -117.3885,
        "Coast Highway 101, Oceanside, CA",
    ),
    ...
    "Solana Beach Coast Highway 101": (
        32.9900,
        -117.2700,
        "North Coast Highway 101, Solana Beach, CA",
    ),
}
...
HIGHWAY_1_VIA_POINTS = (
    ...
    (33.744000, -118.105000),
    (33.701000, -118.055000),
    (33.656000, -118.020000),
    (33.616000, -117.930000),
    (33.570000, -117.820000),
    (33.536000, -117.780000),
    (33.505000, -117.735000),
    (33.476000, -117.710000),
)
