...
RUNNER_INSTRUCTIONS = (
    ...
    Instruction(
        ...
        "left",
        "Abbot Kinney Blvd",
        "Abbot Kinney / Washington Blvd",
    ),
    Instruction(
        "runner",
        "left",
        "Washington Blvd",
        "Washington Blvd / West Washington Blvd",
    ),
    Instruction(
        "runner",
        "fork right",
        "West Washington Blvd",
        "West Washington Blvd / Inglewood Blvd",
    ),
    ...
    Instruction(
        ...
        "right",
        "La Cienega Blvd",
        "La Cienega Blvd / Manchester Ave",
    ),
    ...
    Instruction(
        "runner",
        "follow south until passing under",
        "PCH 1",
        "PCH / river-trail exit area",
    ),
    Instruction(
        "runner",
    ...
    Instruction(
        ...
        "right",
        "Golden Lantern",
        "Golden Lantern / Dana Point Highway Rd",
    ),
    Instruction(
        "runner",
        "left",
        "Dana Point Highway Rd",
        "Dana Point Highway Rd / Park Lantern",
    ),
    Instruction("runner", "right", "Park Lantern", "Park Lantern / Coast Highway"),
    Instruction(
        "runner",
        "continue; road becomes",
        "El Camino Real",
        "El Camino Real / Avenida Valencia",
    ),
    Instruction(
        "runner",
        "right",
        "Avenida Valencia",
        "Avenida Valencia / Avenida del Presidente",
    ),
    ...
    Instruction(
        "runner",
        "resume Coast Highway from",
        "Chevron after I-5 exit 54C",
        "Chevron - I-5 exit 54C runner restart",
    ),
    Instruction(
        "runner",
        "follow",
    ...
    Instruction(
        ...
        "follow; road becomes",
        "Carlsbad Blvd",
        "Coast Highway / Carlsbad Blvd",
    ),
    Instruction(
        "runner",
        "follow; road becomes",
        "Coast Highway 101",
        "Encinitas Coast Highway 101",
    ),
    Instruction(
        "runner",
        "right",
        "Camino del Mar",
        "Camino del Mar / Torrey Pines Rd",
    ),
    Instruction(
        "runner",
        "becomes",
    ...
    Instruction(
        ...
        "right",
        "Torrey Pines Rd",
        "Torrey Pines Rd / La Jolla Shores Dr",
    ),
    Instruction(
        "runner",
        "right",
...
CAR_INSTRUCTIONS = (
    Instruction(
        "car",
        "during river trail, drive ahead and meet runners where trail meets road",
        "LA River Trail",
        "LA River Trail support access",
    ),
    Instruction(
        "car",
        "send replacement runner onto trail and collect outgoing runner",
        "LA River Trail",
        "LA River Trail support access",
    ),
    Instruction(
        "car",
        "fork right to avoid I-5 / Coast Highway conflict",
        "after Park Lantern",
        "Coast Highway car rendezvous",
    ),
    Instruction(
        "car",
        "meet runners on Coast Highway",
        "coastal section",
        "Coast Highway car rendezvous",
    ),
    Instruction(
        "car",
        "pick up runner",
        "San Mateo Point before the I-5 transfer",
        "I-5 runner pickup - San Mateo Point",
    ),
    Instruction(
        "car",
        "drive I-5",
        "from San Mateo Point to exit 54C",
...
ROUTE_CHECKPOINTS = (
    ...
    RouteCheckpoint(
        "Ocean Ave / Pico Blvd",
        "Ocean Avenue & Pico Boulevard, Santa Monica, CA",
    ),
    RouteCheckpoint(
        "Pico Blvd / Main St",
    ...
    RouteCheckpoint(
        "Main St / Abbot Kinney Blvd",
        "Main Street & Abbot Kinney Boulevard, Venice, CA",
    ),
    RouteCheckpoint(
        "Abbot Kinney / Washington Blvd",
        "Abbot Kinney Boulevard & Washington Boulevard, Venice, CA",
    ),
    RouteCheckpoint(
        "Washington Blvd / West Washington Blvd",
    ...
    RouteCheckpoint(
        "West Washington Blvd / Inglewood Blvd",
        "Washington Boulevard & Inglewood Boulevard, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "Inglewood Blvd / Culver Blvd",
        "Inglewood Boulevard & Culver Boulevard, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "Culver Blvd / Mesmer Ave",
        "Culver Boulevard & Mesmer Avenue, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "Mesmer Ave / Centinela Ave",
        "Mesmer Avenue & Centinela Avenue, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "Centinela Ave / Sepulveda Blvd",
        "Centinela Avenue & Sepulveda Boulevard, Culver City, CA 90230",
    ),
    RouteCheckpoint(
        "Sepulveda Blvd / W 78th St",
        "Sepulveda Boulevard & West 78th Street, Los Angeles, CA",
    ),
    RouteCheckpoint("W 78th St / W 79th St", "West 79th Street, Los Angeles, CA"),
    RouteCheckpoint(
        "W 79th St / Isis Ave",
        "West 79th Street & Isis Avenue, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "Isis Ave / W 83rd St",
        "Isis Avenue & West 83rd Street, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "W 83rd St / La Cienega Blvd",
        "West 83rd Street & La Cienega Boulevard, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "La Cienega Blvd / Manchester Ave",
        "La Cienega Boulevard & Manchester Avenue, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "Manchester Ave / Firestone Blvd",
        "Manchester Avenue & Firestone Boulevard, Los Angeles, CA",
    ),
    RouteCheckpoint(
        "Firestone Blvd / Atlantic Ave",
        "Firestone Boulevard & Atlantic Avenue, South Gate, CA",
    ),
    RouteCheckpoint(
        "Atlantic Ave / Rosecrans Ave",
        "Atlantic Avenue & Rosecrans Avenue, Compton, CA",
    ),
    RouteCheckpoint(
        "LA River Trail entry area",
        "LA River Trail - Rosecrans Avenue connector, Compton, CA",
    ),
    ...
    RouteCheckpoint(
        "PCH / river-trail exit area",
        "925 W Esther Street, Long Beach, CA 90813",
    ),
    RouteCheckpoint(
        "Del Prado / Golden Lantern",
        "Del Prado Avenue & Golden Lantern, Dana Point, CA",
    ),
    RouteCheckpoint(
        "Golden Lantern / Dana Point Highway Rd",
        "Golden Lantern, Dana Point, CA",
    ),
    RouteCheckpoint(
        "Dana Point Highway Rd / Park Lantern",
        "Park Lantern, Dana Point, CA",
    ),
    ...
    RouteCheckpoint(
        "Avenida Valencia / Avenida del Presidente",
        "Avenida Valencia & Avenida del Presidente, San Clemente, CA",
    ),
    ...
    RouteCheckpoint(
        "Chevron - I-5 exit 54C runner restart",
        "Chevron, 1601 N Coast Hwy, Oceanside, CA 92054",
    ),
    RouteCheckpoint(
        "Coast Highway / Carlsbad Blvd",
        "Carlsbad Boulevard & Coast Highway, Carlsbad, CA",
    ),
    RouteCheckpoint(
        "Encinitas Coast Highway 101",
    ...
    RouteCheckpoint(
        "Camino del Mar / Torrey Pines Rd",
        "Camino del Mar & Torrey Pines Road, Del Mar, CA",
    ),
    RouteCheckpoint(
        "Torrey Pines Rd / La Jolla Shores Dr",
        "Torrey Pines Road & La Jolla Shores Drive, La Jolla, CA",
    ),
    RouteCheckpoint(
        "La Jolla Shores Dr / Torrey Pines Rd",
        "La Jolla Shores Drive & Torrey Pines Road, La Jolla, CA",
    ),
    RouteCheckpoint(
        "Torrey Pines Rd / Girard Ave",
        "Torrey Pines Road & Girard Avenue, La Jolla, CA",
    ),
    RouteCheckpoint(
        "Girard Ave / Pearl St",
        "Girard Avenue & Pearl Street, La Jolla, CA",
    ),
    RouteCheckpoint("Pearl St / Fay Ave", "Pearl Street & Fay Avenue, La Jolla, CA"),
    RouteCheckpoint(
        "Fay Ave / Nautilus St",
        "Fay Avenue & Nautilus Street, La Jolla, CA",
    ),
    RouteCheckpoint(
        "Nautilus St / La Jolla Blvd",
        "Nautilus Street & La Jolla Boulevard, La Jolla, CA",
    ),
    RouteCheckpoint(
        "La Jolla Blvd / Mission Blvd",
        "La Jolla Boulevard & Mission Boulevard, San Diego, CA",
    ),
    RouteCheckpoint(
        "Mission Blvd / Garnet Ave",
        "Mission Boulevard & Garnet Avenue, San Diego, CA",
    ),
    RouteCheckpoint(
        "Finish - Milestone Running Shop",
        "1892 Garnet Avenue, San Diego, CA 92109",
    ),
)
...
CAR_CHECKPOINTS = (
    RouteCheckpoint(
        "LA River Trail support access",
        "Los Angeles River Bike Path, Long Beach, CA",
    ),
    RouteCheckpoint(
        "Coast Highway car rendezvous",
        "Pacific Coast Highway, Dana Point, CA",
    ),
    RouteCheckpoint(
        "I-5 runner pickup - San Mateo Point",
        "San Mateo Point, San Clemente, CA",
    ),
    RouteCheckpoint(
        "I-5 runner drop-off - Chevron exit 54C",
        "Chevron, 1601 N Coast Hwy, Oceanside, CA 92054",
